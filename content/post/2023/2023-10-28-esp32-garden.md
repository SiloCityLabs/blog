...
1. In Home Assistant, create a custom sensor to handle the data from the analog sensor probes. The custom sensor should be programmed to convert the analog signals into a percentage representing soil moisture.

2. This custom sensor is the core component that will make your system intelligent. It will determine when and how much to water your plants based on the soil moisture readings.
...
![Two Wires as Water Sensing Probe](Image_of_Two_Wires_Water_Sensor.jpg "Two Wires as Water Sensing Probe")
...
![Water Tank Level Sensor](Image_of_Water_Tank_Level_Sensor.jpg "Water Tank Level Sensor")

## HA Moisture Percentage

to calculate moisture we need to write a custom sensor. My sensors output analog 0-3889 so we can use this to write a sensor to add to configuration.yml or sensors.yml files.
